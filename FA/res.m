...
i_shoulder_flx = Revolute('a',0,'alpha',pi/2,'qlim',[0 pi],'offset',0); % DH parameters for 0T1
i_shoulder_ad = Revolute('a',0,'alpha',pi/2,'qlim',[-pi/2 ,pi],'offset',pi/2);
i_shoulder_rot = Revolute('a',2,'alpha',pi/2,'qlim',[-pi/2 pi],'offset',pi);

i_elbow_pron  = Revolute('a',0,'alpha',pi/2,'offset',pi/2,'qlim',[0 pi]);
i_elbow_flex  = Revolute('d',2,'alpha',pi/2,'offset',pi,'qlim',[-pi/2 pi/2]);

i_wrist_flex  = Revolute('a',0,'alpha',pi/2,'offset',-pi,'qlim',[-pi/2 pi/2]);
i_wrist_abd   = Revolute('a',1,'alpha',0,'offset',0,'qlim',[-pi/4 pi/4]);
